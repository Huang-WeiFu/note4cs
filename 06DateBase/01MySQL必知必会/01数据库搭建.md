...
CREATE TABLE `customers` (
  ...
  `cust_contact` char(50) DEFAULT NULL COMMENT '顾客的联系方式',
  `cust_email` char(255) DEFAULT NULL COMMENT '顾客的email地址',
  PRIMARY KEY (`cust_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='顾客数据表';
...
CREATE TABLE `orderitems` (
  ...
  `order_item` int(11) NOT NULL COMMENT '订单物品号(订单中物品顺序)',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单实际数据表';
...
#####################
CREATE TABLE `orders` (
  `order_num` int(11) NOT NULL AUTO_INCREMENT COMMENT '订单ID',
  `order_date` datetime NOT NULL COMMENT '订单日期',
  `cust_id` int(11) NOT NULL COMMENT '订单顾客的ID',
...
CREATE TABLE `products` (
  `prod_id` char(10) NOT NULL COMMENT '唯一产品ID',
  `vend_id` int(11) NOT NULL COMMENT '产品供应商ID',
...
CREATE TABLE `vendors` (
  ...
  `vend_address` char(50) DEFAULT NULL COMMENT '供应商地址',
  `vend_city` char(50) DEFAULT NULL COMMENT '供应商城市',
  ...
  PRIMARY KEY (`vend_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='供应商数据表';
...
CREATE TABLE `productnotes` (
  `note_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '注释ID',
  `prod_id` char(10) NOT NULL COMMENT '产品ID',
  `note_date` datetime NOT NULL COMMENT '添加注释的日期',
  `note_text` text COMMENT '注释的文本信息',
  PRIMARY KEY (`note_id`),
  FULLTEXT KEY `note_text` (`note_text`)
) ENGINE=MyISAM AUTO_INCREMENT=115 DEFAULT CHARSET=utf8 COMMENT='产品注释数据表';

#####################
# Define foreign keys 连接虚拟外键
# 目前主流开发不采用此外键方法
#####################
